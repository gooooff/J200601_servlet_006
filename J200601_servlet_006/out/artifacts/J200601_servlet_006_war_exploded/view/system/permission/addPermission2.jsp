...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form method="post" class="form-x" action="<%=basePath%>permissionController.do?method=add">
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="type" data-validate="required:请输入类型"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="" name="url" data-validate="required:请输入url"/>
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
