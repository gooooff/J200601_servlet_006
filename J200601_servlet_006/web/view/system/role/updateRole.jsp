...
<div class="panel admin-panel">
    ...
    <div class="body-content">
        <form action="<%=basePath%>roleController.do?method=update" method="post" class="form-x" >
            ...
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${role_db.name}" name="name" data-validate="required:请输入名称" />
                    <div class="tips"></div>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="field">
                    <input type="text" class="input w50" value="${role_db.state}" name="state" data-validate="required:请输入状态" />
                    <div class="tips"></div>
                </div>
            </div>
